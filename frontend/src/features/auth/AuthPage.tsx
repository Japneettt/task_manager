...
const FloatingCards = () => (
  <div className="tf-mockup">
    ...
    <div className="tf-card tf-card-mid">
      ...
      <div className="tf-task-row"><span className="tf-task-dot tf-dot-indigo" /><span className="tf-task-name">In Progress</span><span className="tf-task-count">8</span></div>
      <div className="tf-task-row"><span className="tf-task-dot tf-dot-green" /><span className="tf-task-name">Completed</span><span className="tf-task-count">24</span></div>
    </div>
    ...
    <>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .tf-features { display: flex; flex-direction: column; gap: 22px; margin-bottom: 40px; }
        ...
        .tf-or-line { flex: 1; height: 1px; background: #F3F4F6; }
 
        .tf-social { display: flex; gap: 10px; margin-bottom: 24px; }
        .tf-social-btn {
          flex: 1;
        ...
        .tf-social-btn:hover { background: #FAFAFA; border-color: #D1D5DB; box-shadow: 0 2px 8px rgba(0,0,0,0.06); }
        ...
        .tf-footer-dot { width: 3px; height: 3px; border-radius: 50%; background: #D1D5DB; }
      ...
      <div className="tf-root">
        ...
        {/* NAV */}
        {/* <nav className="tf-nav" style={{ position: "relative", zIndex: 100 }}>
          <div className="tf-nav-logo">
            <div className="tf-nav-logo-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="9 11 12 14 22 4" />
                <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" />
              </svg>
            </div>
            TaskFlow<span style={{ color: "#7C3AED" }}>.</span>
          </div>
          <div className="tf-nav-actions">
            <button className="tf-nav-btn">
              <IconGlobe /> English <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="6 9 12 15 18 9" /></svg>
            </button>
            <div className="tf-nav-divider" />
            <button className="tf-nav-btn"><IconSun /></button>
            <button className="tf-nav-btn"><IconMoon /></button>
          </div>
        </nav> */}
        ...
        <div className="tf-body" style={{ position: "relative", zIndex: 1 }}>
          ...
          <div className="tf-left">
            ...
            <p className="tf-subtext">
              TaskFlow helps teams organize work, track progress, and achieve more together in one connected workspace.
            </p>
            ...
            <div className="tf-social-proof">
              ...
              <div>
                <div className="tf-proof-text">10,000+ teams trust TaskFlow</div>
