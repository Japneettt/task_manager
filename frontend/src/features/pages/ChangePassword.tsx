  ...
  return (
    <div className="pageShell">
      ...
      <div className="leftPanel">
        {/* ✅ BACK BUTTON now sits inline above the icon badge, no overlap */}
        <button
          className="backBtn"
          onClick={() => navigate(-1)}
          aria-label="Go back"
      ...
      <div className="rightPanel">
        <div className="card">
          ...
          {/* spacer pushes footer down ONLY if content is short — flex-grow on a
              dedicated element instead of margin-top:auto on the footer itself,
              so the footer hugs the content instead of the empty card bottom */}
      ...
      * {
      ...
      /* ✅ FIXED: back button is now a normal inline element at the
         top of leftPanel, not absolutely positioned — so it can never
         overlap the icon badge below it. */
      .backBtn {
        display: inline-flex;
        align-items: center;
        gap: 6px;
      ...
      .rightPanel {
        ...
        min-width: 0;
        overflow: hidden;
        /* ✅ keep the right column vertically centered as a group instead of
           stretching the card to fill all available height */
        justify-content: center;
      }

      /* ✅ FIXED: card no longer has flex:1 (which forced it to stretch
         to fill the whole right panel height, creating the big gap before
         the footer). It now sizes to its content. */
      .card {
        background: #ffffff;
      ...
      /* ✅ FIXED: no more margin-top:auto — footer now sits right after
         the fields with a normal top border, no forced gap */
      .cardFooter {
        display: flex;
