...
//   height: 120px !important;   /* ✅ bigger like Trello */
//   padding: 8px;
//   border: 1px solid #f0f0f0;  /* ✅ grid lines */
//   vertical-align: top;
//   background: #fff;
// }
...
//                         className="task-pill"
//                         style={{
//                           borderLeft: `4px solid ${colors[i % colors.length]}` // ✅ MULTI COLORS
//                         }}
//                       >
//                         {task.title}
//                       </div>
